...
import com.example.ratingreview.ratingdialog.buttons.ConfirmButtonClickListener
import com.example.ratingreview.ratingdialog.buttons.CustomFeedbackButtonClickListener
import com.example.ratingreview.ratingdialog.buttons.RateButton
import com.example.ratingreview.ratingdialog.buttons.RateDialogClickListener
import com.example.ratingreview.ratingdialog.dialog.DialogOptions
import com.example.ratingreview.ratingdialog.dialog.RateDialogFragment
import com.example.ratingreview.ratingdialog.preferences.MailSettings
import com.example.ratingreview.ratingdialog.preferences.PreferenceUtil
import com.example.ratingreview.ratingdialog.preferences.RatingThreshold
import com.example.ratingreview.ratingdialog.preferences.toFloat
import com.example.ratingreview.ratingdialog.utils.FeedbackUtils
import com.example.ratingreview.ratingdialog.logging.RatingLogger
import com.example.ratingreview.ratingdialog.preferences.ConditionsChecker
...
object AppRating {
    ...
    data class Builder(var componentActivity: ComponentActivity) {
        ...
        fun showRateNeverButtonAfterNTimes(
            ...
            RatingLogger.debug(
                componentActivity.getString(
                    R.string.rating_dialog_log_show_rate_never_button_later,
        ...
        fun setUseCustomFeedback(useCustomFeedback: Boolean) = apply {
            ...
            RatingLogger.debug(
                componentActivity.getString(
                    R.string.rating_dialog_log_use_custom_feedback,
                    useCustomFeedback
                )
            )
        }
        ...
        fun setRatingThreshold(ratingThreshold: RatingThreshold) = apply {
            ...
            RatingLogger.debug(
                componentActivity.getString(
                    R.string.rating_dialog_log_set_rating_threshold,
                    ratingThreshold.toFloat()
                )
            )
        }
        ...
        fun setCancelable(cancelable: Boolean) = apply {
            ...
            RatingLogger.debug(
                componentActivity.getString(
                    R.string.rating_dialog_log_set_cancelable,
                    cancelable
                )
            )
        }
        ...
        fun setDebug(isDebug: Boolean) = apply {
            ...
            RatingLogger.warn(
                componentActivity.getString(
                    R.string.rating_dialog_log_set_debug,
                    isDebug
                )
            )
        }
        ...
        fun showIfMeetsConditions(): Boolean {
            ...
            return if (isDebug || ConditionsChecker.shouldShowDialog(
                    componentActivity,
                    dialogOptions
                )
            ) {
        ...
        internal fun showGoogleInAppReview() {
            ...
            requestTask.addOnCompleteListener { request ->
                if (request.isSuccessful) {
                    ...
                    val flow =
                        reviewManager?.launchReviewFlow(componentActivity, reviewInfo) ?: run {
                            onGoogleInAppReviewFailure(componentActivity.getString(R.string.rating_dialog_log_in_app_review_initial_request_is_null))
                            return@addOnCompleteListener
                        }
        ...
        private fun onGoogleInAppReviewFailure(additionalInfo: String) {
            RatingLogger.warn(
                componentActivity.getString(
                    R.string.rating_dialog_log_in_app_review_not_successful,
                    additionalInfo
                )
            )
